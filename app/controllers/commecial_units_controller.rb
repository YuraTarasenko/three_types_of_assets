class CommecialUnitsController < ApplicationController
  ...
  def create
    @commecial_unit = current_manager.commecial_units.new(commecial_unit_params)
  ...
  private
    ...
    def commecial_unit_params
      params.require(:commecial_unit).permit(:owner, :address, :shops, :sqmt, :parking, :price, :avatar)
    end
end
